...
Part~(i) summarizes performance through the detection efficiency
$2\kappa\mu/\sigma^2$, where $\kappa=k-\eta$ and $\mu$ are the in-control
and post-change margins.  Under a Gaussian innovation mean shift of size
