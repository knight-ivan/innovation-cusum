...
\label{rem:interp-lemma}
  ...
  Theorem~\ref{thm:mds}.  The lemma's role here is scoping: it identifies
  the tail $\sigma$-algebra as the natural carrier of any ``long-run
  summary'' interpretation, and it motivates conditioning on the two-sided
  past in Section~\ref{sec:rnn-decomp}, where the object of analysis is
  the stationary innovation rather than a tail limit of $h_t$.
\end{remark}
