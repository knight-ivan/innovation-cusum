...
\label{thm:optimality}
  ...
  \begin{enumerate}[label=(\roman*), itemsep=3pt]
    \item \textbf{(Order optimality.)}  Under Assumption~\ref{ass:pathway}
      ...
      information number of the change.  The detector is thus order-optimal,
      with \emph{detection efficiency} $2\kappa\mu/\sigma^2$; first-order
      optimality requires this efficiency to equal $I$, i.e.\ part~(ii).
